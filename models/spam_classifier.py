...
if 'text' in df.columns and 'target' in df.columns:
    ...
    # assume first column is index/id, second is text, third is label
    df = df.iloc[:, [1, 2]].copy()
...
# Parsing function for textual labels
def parse_label(val):
...
# Apply parsing and drop invalid
...
if __name__ == '__main__':
    sample = "Congratulations, you have won a free cruise!"
