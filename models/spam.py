...
# 7. Build classification pipeline using Multinomial Naive Bayes
pipeline = Pipeline([
...
# 10. Save model
model_filepath = 'spam_nb_classifier_model.pkl'
...
if __name__ == '__main__':
    sample = "Congratulations, you've won a free cruise!"
